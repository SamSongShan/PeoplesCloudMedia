...
public class GetNewsListAdapter extends AbsRecyclerViewAdapter<GetNewsListEntity.DataBean.ArtilesBean> {
    private final OnAdapterCallbackListener onAdapterCallbackListener;
    private View.OnClickListener onClickListener;

    public GetNewsListAdapter(Context context, OnAdapterCallbackListener onAdapterCallbackListener, View.OnClickListener onClickListener) {
